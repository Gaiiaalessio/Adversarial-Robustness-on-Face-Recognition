...
from RobFR.benchmark.utils import run_white
...
parser.add_argument('--iters', help='Attack iterations', type=int, default=100)
parser.add_argument('--steps', help='Number of search steps', type=int, default=10)
parser.add_argument('--bin_steps', help='Number of binary search steps', type=int, default=10)
parser.add_argument('--confidence', help='Kappa (confidence level)', type=float, default=1e-3)
parser.add_argument('--c', help='Regularization parameter', type=float, default=1)
parser.add_argument('--eps', help='Epsilon for attack', type=float, default=255)
parser.add_argument('--lr', help='Learning rate', type=float, default=1e-3)
parser.add_argument('--seed', help='Random seed', type=int, default=1234)
parser.add_argument('--distance', help='Distance metric (l2)', type=str, default='l2', choices=['l2'])
